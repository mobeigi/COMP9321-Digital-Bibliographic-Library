...
<head>
    ...
    <link href="css/bootstrap/plugins/owl-carousel/owl.theme.css" rel="stylesheet">
    <link href="css/bootstrap/plugins/owl-carousel/owl.transitions.css" rel="stylesheet">
    <link href="css/bootstrap/plugins/Lightbox/dist/css/lightbox.css" rel="stylesheet">
    <link href="css/bootstrap/plugins/Icons/et-line-font/style.css" rel="stylesheet">
    <link href="css/bootstrap/plugins/animate.css/animate.css" rel="stylesheet">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="images/logo/logo_white.png" class="img-responsive" alt="logo"></a>
            </div>
            <div class="collapse navbar-collapse text-center" id="bs-example-navbar-collapse-1">
                <div class="col-md-8 col-xs-12 nav-wrap">
                    <ul class="nav navbar-nav">
                        <li><a href="/" class="page-scroll">Home</a></li>
                        <li><a href="#" class="page-scroll">Temp1</a></li>
                        <li><a href="#" class="page-scroll">Temp2</a></li>
                        <li><a href="#" class="page-scroll">Temp3</a></li>
                        <li><a href="#" class="page-scroll">Temp4</a></li>
                    </ul>
                </div>
...
<footer>
    <div class="container">
        ...
        <h6>Copyright &copy; 2016. Mohammad Ghasembeigi. All rights reserved.<br />
            Theme: Rise.Development By BootstrapDev</h6>
    </div>
</footer>
...
<script src="css/bootstrap/bootstrap-assets/js/bootstrap.min.js"></script>
<script src="css/bootstrap/js/custom.js"></script>
<!-- JS PLUGINS -->
<script src="css/bootstrap/plugins/owl-carousel/owl.carousel.min.js"></script>
<script src="css/bootstrap/js/jquery.easing.min.js"></script>
<script src="css/bootstrap/plugins/waypoints/jquery.waypoints.min.js"></script>
<script src="css/bootstrap/plugins/countTo/jquery.countTo.js"></script>
<script src="css/bootstrap/plugins/inview/jquery.inview.min.js"></script>
<script src="css/bootstrap/plugins/Lightbox/dist/js/lightbox.min.js"></script>
<script src="css/bootstrap/plugins/WOW/dist/wow.min.js"></script>
<!-- GOOGLE MAP -->
